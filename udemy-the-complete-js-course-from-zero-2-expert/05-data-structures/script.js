...
const anArr = [1, 2, 3];
const newArr = [...anArr, 4, 5];
console.log('new ... array:', newArr);

const concatArr = [...newArr, ...anArr];
...
console.log(add(...anArr));
const [one, two, ...rest] = newArr;
console.log(a, b, rest);

const {title: tl, author: auth, ...others} = firstBook;
console.log(tl, auth, others);
...
console.log(undefined || '' || null || 'hello' || 10);